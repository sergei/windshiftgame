...
function RaceCourse(props) {
    ...
    const layLineColor = props.layLineCrossed ? 'lightgrey' : 'blue'
    const layLine = props.layLine.map( (v) => {return v / props.milesInPixel})
    ...
    return (
        <Group>
            ...
            <Line points={[props.rc.pin.x/props.milesInPixel, props.rc.pin.y/props.milesInPixel, props.rc.rcb.x/props.milesInPixel, props.rc.pin.y/props.milesInPixel]} stroke={'black'}/>
            <Line points={layLine} stroke={layLineColor} />
        </Group>
    );
